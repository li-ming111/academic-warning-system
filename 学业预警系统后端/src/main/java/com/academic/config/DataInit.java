    ...
    private void initCourses2025(Statement stmt) {
        try {
            ...
            if (rs.next() && rs.getInt("cnt") > 0) {
                System.out.println("[DataInit] 2025-2026-1 courses already initialized");
                return;
            }
            ...
            // Insert scores
            stmt.execute("INSERT INTO scores (student_id, course_id, semester, score_total, grade_point, created_at, updated_at) VALUES " +
