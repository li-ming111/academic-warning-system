    ...
    <el-dialog v-model="submitDialogVisible" title="提交成绩申诉" width="600px">
      <el-form :model="appealForm" label-width="100px">
        <el-form-item label="成绩ID">
          <el-input-number v-model="appealForm.scoreId" :min="1"></el-input-number>
        </el-form-item>
...
const loadAppeals = async () => {
  try {
    ...
    const data = await studentAPI.getAppeals(userId)
...
const submitAppeal = async () => {
  if (!appealForm.value.scoreId) {
    ElMessage.warning('请选择成绩')
    return
  }
